...
const loginForm = useFormik({ 
  ...
  return (
    ...
    <div className='min-h-screen  bg-gradient-to-bl from-purple-500 via-transparent to-pink-500 dark:via-transparent]'>
   <div className=" py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">

    <form 
    onSubmit={loginForm.handleSubmit}
    className="mt-15 mx-auto max-w-lg rounded-lg  shadow-2xl  bg-white">
      <div className="flex flex-col gap-4 p-4 md:p-8">
        <h2 className="mb-4 text-center text-2xl font-bold text-black md:mb-8 lg:text-4xl">
      Login
    </h2>
        <div>
          <label
            htmlFor="email" className="mb-2 inline-block text-lg font-semibold text-black sm:text-base">
            Email
          </label>
          <input type="email"
            id="email"
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="relative bg-white px-4 text-sm text-black">
            Log in with social
          </span>
        </div>
